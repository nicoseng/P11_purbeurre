...
class TestAuthentication(LiveServerTestCase):
    def setUp(self):
        # pythonpath = '/home/travis/build/nicoseng/P10_purbeurre/purbeurre_website/tests/functional_tests/'
        pythonpath = '/Users/nicolassengmany/Desktop/OCR/Python/Projets/P10_purbeurre/purbeurre_website/tests/functional_tests/chromedriver'
